...
STRATEGIES = [
    ...
    },
    {
        "id": "pdhl_breakout",
        "name": "PDHL Breakout",
        "description": "Previous day high/low breakout with volume confirmation",
        "best_when": "Trending markets, moderate vol, clear levels",
        "rules": {
    ...
    },
    {
        "id": "vwap_reversion",
        "name": "VWAP Reversion",
        "description": "Mean reversion from VWAP sigma bands",
        "best_when": "Range-bound, elevated vol, choppy markets",
        "rules": {
            "Volatility": {"Low Vol": "CAUTION", "Normal": "GO", "Elevated": "GO", "Crisis": "CAUTION"},
            "Cycle": {"Expansion": "GO", "Recovery": "CAUTION", "Late Cycle": "GO", "Contraction": "CAUTION"},
            "Risk": {"Risk-On": "CAUTION", "Mixed": "GO", "Risk-Off": "CAUTION"},
            "Monetary": {"Easing": "GO", "Pause": "GO", "Tightening": "GO"},
            "Credit": {"Normal": "GO", "Complacent": "GO", "Stress": "CAUTION"},
        },
    },
    {
        "id": "fvg_fill",
        "name": "FVG Fill",
        "description": "Fair value gap fill — 3-candle pattern on daily chart",
        "best_when": "Volatile with gaps, trending or reverting",
        "rules": {
            "Volatility": {"Low Vol": "SIT OUT", "Normal": "GO", "Elevated": "GO", "Crisis": "CAUTION"},
            "Cycle": {"Expansion": "GO", "Recovery": "GO", "Late Cycle": "GO", "Contraction": "CAUTION"},
            "Risk": {"Risk-On": "GO", "Mixed": "GO", "Risk-Off": "CAUTION"},
            "Monetary": {"Easing": "GO", "Pause": "GO", "Tightening": "CAUTION"},
            "Credit": {"Normal": "GO", "Complacent": "GO", "Stress": "CAUTION"},
        },
